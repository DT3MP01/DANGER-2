...
public class WorldGenerator : RoomPopulator
{
    ...
    void roomGenerator(generatorPoint genP)
    {
        ...
        if (!ocuppied)
        {
            ...
            /*Una vez creadas las paredes, creamos un plano con el tama�o original de anchura y largo, que se corresponde con las dimensiones de la habitaci�n. Como los planos en Unity se crean por defecto con dimensiones 10x10,
