        ...
        if(other.tag == "Player")
        {
                if (actived == false)
                {
                        if (itemToGet == Items.ItemType.ALARM)
                        {
                            actived = true;
                            AS.Play();
                            player.GetComponent<Sensor>().addItem(Items.ItemType.ALARM);
                        ...
                        {
                            actived = true;
                            player.GetComponent<Sensor>().addItem(Items.ItemType.TOWEL);
                        ...
                        {
                            //Si no tiene toalla
                            if (!player.GetComponent<Sensor>().GetItemList().Contains(Items.ItemType.TOWEL))
                            {
                            ...
                            {
                                actived = true;
                                player.GetComponent<Sensor>().addItem(Items.ItemType.WET_TOWEL);
